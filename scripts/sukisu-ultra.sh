...
#
# Copyright (C) 2023-2026 Unitrix Kernel
#
...
{
   if ! [ -d $KERNELSU ]; then
       git clone https://github.com/SukiSU-Ultra/SukiSU-Ultra.git $KERNELSU > /dev/null 2>&1
...
{
   if ! [ -d $KERNELSU ]; then
       git clone https://github.com/SukiSU-Ultra/SukiSU-Ultra.git -b main $KERNELSU > /dev/null 2>&1
   fi
}
